...
@scheduler.scheduled_job('cron', id='downloadNewCoins',day_of_week='sun',hour=23,minute=59)
...
def update_indicator(csv_filename,periods,timeframe,datetimeformat_string):
    ...
    for coin_name in data:
        ...
        for key, item in df_groupby:
            ...
            req_data2['MACD'],req_data2['MACD_SIGNAL'],MACD_HISTOGRAM = talib.func.MACD(req_data2.close.values,fastperiod=MACD_FAST,slowperiod=MACD_SLOW,signalperiod=MACD_SIGNAL)
